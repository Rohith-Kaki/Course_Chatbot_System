...
//       ml: "Machine Learning",
//     }, //here keys will the same, that we use from the url for backend. (ie: all small case without spaces)
//     // requiredDocs: ["File 1"],
//   },
//   school_of_business: {
//     specializations: {
...
//     const courseName = educationData[selectedSchool as keyof typeof educationData].specializations[courseKey];
...
//   return (
//     <div
//       className=" realtive w-full min-h-screen bg-cover bg-no-repeat overflow-hidden flex flex-col items-center justify-center bg-[#F39CA6] py-12 px-12 sm:px-6 lg:px-8"
//       style={{
...
//       <div className="realtive z-10  max-w-md mx-auto bg-white rounded-lg shadow-md p-8">
...
//               <div className="h-8 w-8 border-4 border-t-4 border-t-blue-500 rounded-full animate-spin"></div>
//             </div>
//           )}
